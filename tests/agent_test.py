...
def testAgentNuclei_whenBinaryAvailable_RunScan(scan_message, mocker):
    ...
    mock_report_vulnerability.assert_called_with(
        ...
        technical_detail='## Target: \n'
                     ...
                     "Safari/537.36''https://***REMOVED***.com?lang=%22%3E%3C%2Fscript%3E%3Cscr"
                     ...
                     'Chrome/49.0.2656.18 '
                     'Safari/537.36\'\'https://***REMOVED***.com?lang=%22%3E%3C%2Fscript%3E%3Cscript%3Ealert%28'
                         'document.domain%29%3C%2Fscript%3E%3Cp%20class=%22&p=1\'",\n'
                     '    "host": "https://***REMOVED***.com",\n'
                     '    "info": {\n'
                     '        "author": [\n'
                     '            "pikpikcu"\n'
                     '        ],\n'
                     ...
                     '    "ip": "50.18.113.127",\n'
                     '    "matched-at": '
                     '"https://***REMOVED***.com?lang=%22%3E%3C%2Fscript%3E%3Cscript%3Ealert%28document.domain%29%'
